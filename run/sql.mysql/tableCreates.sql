...
) Engine=InnoDB shardkey=cfg_name;
...
create table bmsql_history (
  ...
  h_data   varchar(24),
  primary key (hist_id, h_c_w_id)
)Engine=InnoDB shardkey=h_c_w_id;
...
) Engine=InnoDB shardkey=no_w_id;
...
) Engine=InnoDB shardkey=ol_w_id;
